...
(4, 'SERV-001', '81101508', 'Servicio de ConsultorÃ­a en GestiÃ³n de Proyectos', 'ZZ', '10', 150.0000, 0.0000, 1, 1, 0, 0, 1),
(5, 'SERV-002', '81141601', 'Servicio de Transporte LogÃ­stico Local LIMA', 'ZZ', '10', 450.0000, 320.0000, 1, 1, 0, 0, 1);
...
(1, '6', '20100456781', 'CONSTRUCTORA SAN JOSÃ‰ S.A.C.', 'Constructora San JosÃ©', 'Av. Javier Prado Este 1024', '150131', 'compras@sanjose.com.pe', '014223456', 'cliente', 1),
...
(1, 1, 'Ing. Luis Fernando GÃ³mez', 'Gerente de Proyectos', '987654321', 'lgomez@sanjose.com.pe', 1),
(2, 1, 'Lic. Maria Elena Paz', 'Jefa de Compras', '987112233', 'mpaz@sanjose.com.pe', 1),
(3, 2, 'Ing. Roberto Carlos Arce', 'Supervisor de LogÃ­stica', '955443322', 'rarce@minerasur.pe', 1),
...
(1, '6', '20334455661', 'ACEROS INDUSTRIALES DEL PERÃš S.A.', 'Av. Argentina 4560', '070101', '014512030', 'ventas@acerosind.com.pe', 1),
(2, '6', '20112233445', 'CORPORACIÃ“N LOGÃSTICA TRANSVIAL S.A.C.', 'Av. Elmer Faucett 120', '070101', '015748930', 'operaciones@transvial.pe', 1),
...
(3, 3, 'Patricia Pilar ZuÃ±iga', 'Administradora General', '954778899', 'pzuniga@distrimat.pe', 1);
...
(1, 2, 'F3G-820', 'Volvo', 'FMX 460', 'TractocamiÃ³n Volquete', 1),
(2, 2, 'B4W-711', 'Scania', 'P410', 'CamiÃ³n Plataforma', 1),
(3, 3, 'V1Z-943', 'Hyundai', 'HD78', 'CamiÃ³n FurgÃ³n 5 Tn', 1);
...
(2, 2, 'Jorge Washington CÃ¡rdenas Vega', '1', '08123456', 'V08123456-A3B', 1),
(3, 3, 'Aurelio Segundo Condori Mamani', '1', '29456712', 'M29456712-A2B', 1);

SET IDENTITY_INSERT comercial.conductoresproveedores OFF;
GO

PRINT 'Â¡MÃ³dulo Comercial poblado exitosamente sin errores!';

-- ==========================================================================================
-- 1. POBLAR: operaciones.almacenes (Multi-almacÃ©n - Referencia a ubigeos)
-- ==========================================================================================
...
(1, 'ALM-01', 'AlmacÃ©n Central Lima', 'Av. Argentina 2450', '150101', 1),
(2, 'ALM-02', 'AlmacÃ©n Callao LogÃ­stico', 'Av. NÃ©stor Gambetta km 3.5', '070101', 1),
(3, 'ALM-03', 'AlmacÃ©n Regional Arequipa', 'Parque Industrial s/n', '040101', 1);
...
(1, 1, 'Edificio Residencial San JosÃ© - Miraflores', 'ConstrucciÃ³n de un condominio de 15 pisos.', 1500000.0000, 0.0000, '2026-01-15', '2026-12-20', 'en progreso'),
(2, 2, 'AmpliaciÃ³n Planta de Procesos Sur', 'OptimizaciÃ³n de fajas transportadoras e infraestructura tÃ©cnica.', 850000.0000, 0.0000, '2026-03-01', '2026-09-30', 'en progreso'),
(3, 3, 'HabilitaciÃ³n Urbana Lomas del Sol', 'Obras de saneamiento y pavimentaciÃ³n estructural.', 450000.0000, 0.0000, '2026-05-10', NULL, 'planificado');
...
(1, 1, 'ExcavaciÃ³n y Movimiento de Tierras', '2026-01-15', '2026-02-28', 100.00, 80000.0000, 'completada'),
(2, 1, 'CimentaciÃ³n y Estructuras Base', '2026-03-01', '2026-06-30', 45.50, 350000.0000, 'en ejecucion'),
(3, 2, 'IngenierÃ­a de Detalle y Planos', '2026-03-01', '2026-04-15', 100.00, 30000.0000, 'completada'),
(4, 2, 'Montaje ElectromecÃ¡nico de Fajas', '2026-04-16', '2026-08-15', 15.00, 500000.0000, 'en ejecucion'),
...
(1, 1, 1, 1000.0000, 42.5000, 500.0000, 42000.0000), -- 1000 Fierros para Proyecto San JosÃ©
(2, 2, 4, 100.0000, 150.0000, 0.0000, 15000.0000),  -- 100 horas de ConsultorÃ­a (en USD) para Minera del Sur
...
(1, 'OC-2026-001', 1, 1, 'Ing. Luis Fernando GÃ³mez', '2026-02-15', 'pen', 31200.0000, 'materiales', 'aprobado'),
...
(2, 2, 5, 10.0000, 450.0000, 4500.0000),    -- Servicio de transporte logÃ­stico local (Transvial)
...
-- ==========================================================================================
-- 9. POBLAR: operaciones.comprobantesfacturacion (FacturaciÃ³n ElectrÃ³nica - Depende de pedidos y clientes)
-- ==========================================================================================
...
-- ==========================================================================================
-- 10. POBLAR: operaciones.guiasremision (GuÃ­as SUNAT - Depende de almacenes, vehÃ­culos y conductores)
-- ==========================================================================================
...
(2, 'T001', '00000002', '2026-02-22', '01', 1, NULL, NULL, 2, 2, 2500.00, 'kgm', 'aceptado'); -- GuÃ­a remitente ligada a despacho de venta
...
(1, 1, 1, 'ent', 'compra', 'OC-2026-001', 1000.0000, 31.2000, '2026-02-15'), -- Entrada fÃ­sica por abastecimiento de OC
(2, 1, 1, 'sal', 'venta', 'PED-2026-001', 500.0000, 31.2000, '2026-02-22'),  -- Salida fÃ­sica por despacho de pedido
(3, 1, 2, 'ent', 'ajuste', 'AJU-2026-001', 50.0000, 21.5000, '2026-05-10');   -- Entrada por ajuste de inventario (auditorÃ­a)

SET IDENTITY_INSERT operaciones.kardexmovimientos OFF;
GO

PRINT 'Â¡MÃ³dulo de Operaciones poblado exitosamente sin errores!';
...
(@v_cuentabcp, 'ing', '003', 1180.0000, @v_comprobanteid, null, 'cobro total de factura comercial liquidadas por transferencia de fondos bcp', getdate()),
(@v_cuentabcp, 'egr', '003', 590.0000, null, @v_ordenid, 'pago programado a proveedor logistico por orden de compra autorizada', getdate());
go
...
('act-2026-003', 'muebles modulares de oficina ergonÃ³micos - sala de TI', null, '2026-03-01', 4500.0000, 10.00, 112.5000, 'activo');
go
...
('202605', 'rvie', null, getdate(), 'propuesta_sunat', null);
go
...
-- tokens del administrador (id 1): uno expirado/usado y uno activo vÃ¡lido
(1, 1, 'rt_mock_7f8a9b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b2c3d4e5f6a7b8c9d0e1f2a', 'jti-998877-aaaa-bbbb-cccc-111122223333', 1, 0, dateadd(day, -7, getdate()), dateadd(day, -6, getdate())),
(2, 1, 'rt_mock_1a2b3c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b', 'jti-112233-dddd-eeee-ffff-444455556666', 0, 0, getdate(), dateadd(day, 7, getdate())),

-- tokens del usuario comercial (id 2): token revocado preventivamente por sospecha
(3, 2, 'rt_mock_z1y2x3w4v5u6t7s8r9q0p1o2n3m4l5k6j7i8h9g0f1e2d3c4b5a6z7y8x9w8v7u6', 'jti-445566-xxxx-yyyy-zzzz-777788889999', 0, 1, dateadd(day, -1, getdate()), dateadd(day, 6, getdate())),

-- tokens del usuario operaciones (id 3): activo
(4, 3, 'rt_mock_aa11bb22cc33dd44ee55ff66gg77hh88ii99jj00kk11ll22mm33nn44oo55pp66', 'jti-778899-ffff-gggg-hhhh-000011112222', 0, 0, getdate(), dateadd(day, 7, getdate()));
...
-- admin (id 1): doble sesiÃ³n activa simultÃ¡nea (simula control de concurrencia)
(1, 1, 2, '192.168.1.100', 'chrome 125.0.0.0', 'windows 11 pro', dateadd(hour, -4, getdate()), dateadd(minute, -5, getdate()), 1),
(2, 1, 2, '172.16.20.45', 'safari mobile 17.4', 'iphone 15 pro', dateadd(hour, -2, getdate()), dateadd(minute, -15, getdate()), 1),

-- comercial (id 2): sesiÃ³n cerrada/inactiva (debido a la revocaciÃ³n de su token)
(3, 2, 3, '190.235.45.12', 'firefox 126.0', 'ubuntu linux 22.04', dateadd(day, -1, getdate()), dateadd(day, -1, getdate()), 0),

-- operaciones (id 3): sesiÃ³n mÃ³vil activa en ruta
(4, 3, 4, '100.12.98.174', 'chrome mobile 125.0', 'android 14 (samsung s24)', dateadd(hour, -1, getdate()), getdate(), 1);
...
(1, 'admin@empresa.com.pe', '192.168.1.100', 1, null, dateadd(hour, -4, getdate())),

-- simulaciÃ³n de ataque de fuerza bruta desde una ip externa (mismo atacante errando claves continuamente)
(2, 'admin@empresa.com.pe', '203.0.113.84', 0, 'contrasena_incorrecta', dateadd(minute, -25, getdate())),
(3, 'root@empresa.com.pe', '203.0.113.84', 0, 'contrasena_incorrecta', dateadd(minute, -23, getdate())),
(4, 'supervisor@empresa.com.pe', '203.0.113.84', 0, 'contrasena_incorrecta', dateadd(minute, -21, getdate())),
(5, 'ventas@empresa.com.pe', '203.0.113.84', 0, 'contrasena_incorrecta', dateadd(minute, -20, getdate())),

-- simulaciÃ³n de fallo por token mfa caducado o mal digitado
(6, 'lgomez@sanjose.com.pe', '190.235.45.12', 0, 'mfa_expirado', dateadd(minute, -45, getdate()));

set identity_insert seguridad.usuario_intentos_login off;
go

-- ==========================================================================================
-- 4. poblar: seguridad.usuario_historial_passwords (polÃ­tica estricta de no repeticiÃ³n)
-- ==========================================================================================
...
(1, 1, '$2y$12$mcrxexhbyfzknykyq5gupuxyisxemvszh0z9y1aqvbg2j/kyvjtuq', dateadd(month, -6, getdate())),
(2, 1, '$2y$12$ktb6gqndv3gkrkdfmvdheuzfuk57huxq6rcc04asw0fvw.hgh4oeq', dateadd(month, -3, getdate())),

-- historial de cambios del usuario de finanzas
(3, 4, '$2y$12$fbgswwre112kdaakscvfgexuozbpxmrrk99kqa99vfbvdxxwqqsqs', dateadd(month, -2, getdate()));

set identity_insert seguridad.usuario_historial_passwords off;
go

-- ==========================================================================================
-- 5. poblar: seguridad.usuario_mfa (seguridad multi-factor obligatoria para flujos crÃ­ticos)
-- ==========================================================================================
...
(1, 1, 'totp', 'nxw64z3p7x47vuzled2g65zqnuyx2k3z', 1, 'backup_hash_1aef38,backup_hash_4f7e12,backup_hash_99bc87', dateadd(month, -3, getdate())),

-- comercial: configurado con sms en modo inactivo o pendiente de validaciÃ³n inicial
(2, 2, 'sms', 'encrypted_seed_string_for_sms_gateway_flow_002', 0, null, getdate()),

-- finanzas: totp activo (cuenta de alta responsabilidad fiscal)
(3, 4, 'totp', 'mzxw6ytboi2dcmrtguzdgnbvgaydamzq', 1, 'backup_hash_ff4411,backup_hash_ee5522', dateadd(month, -1, getdate()));

set identity_insert seguridad.usuario_mfa off;
go

print '*** inicializaciÃ³n del esquema de seguridad avanzada completado ***';
...
(2, '0022', 'regimen mype - pequeÃ±a empresa', 1);
...
(1, 'sunat_uit_valor', '5150', 'valor oficial de la unidad impositiva tributaria para el aÃ±o fiscal 2026', 'tributario', getdate()),
(2, 'app_version', '1.4.2-build-net8', 'version de produccion del backend api rest en .net core 8', 'sistema', getdate()),
(3, 'mfa_forced_all', 'false', 'interruptor general para forzar doble factor de autenticacion obligatorio', 'seguridad', getdate());
...
(1, 'admin.sge', dateadd(minute, -60, getdate()), null, '192.168.1.100', 'windows 11 workstation (chrome 125)', 'jwt_sys_token_mock_001_xyz', 1),
(2, 'lgomez.comercial', dateadd(hour, -5, getdate()), dateadd(hour, -3, getdate()), '192.168.1.105', 'android client app v1.4', 'jwt_sys_token_mock_002_abc', 0);
...
(1, 'admin.sge', 'rrhh_nomina.conceptos_empleados_fijos', 'update', dateadd(day, -1, getdate()), '1', '{"montofijo":5200.00}', '{"montofijo":5500.00}'),
(2, 'mpaz.operaciones', 'rrhh_recursos.asistencias_diarias', 'insert', dateadd(day, -5, getdate()), '3', null, '{"empleadoid":3,"estadoasistencia":"asistio"}');
...
(2, 'rep_kardex_val', 'kardex valorizado general de existencias', 'movimientos histÃ³ricos de inventarios y valorizaciÃ³n contable de almacenes', 'operaciones', 'sp_reporte_kardex_valorizado', 1);
...
(1, 1, 'admin.sge', dateadd(hour, -1, getdate()), '{"anio":2026,"mes":5,"tipoplanilla":"regular_mensual"}', 'excel', 3);
...
-- procedure 1: motor de movimientos de almacÃ©n (kardex + actualizaciÃ³n de stock)
...
begin
    ...
    begin try
        ...
        -- 1. insertar el registro histÃ³rico e inmutable en el kardex
        ...
        -- 2. garantizar que el casillero de stock exista para ese producto en ese almacÃ©n
        ...
        -- 3. operar el stock fÃ­sico segÃºn la direcciÃ³n del movimiento
        ...
        begin
            -- validaciÃ³n de seguridad: evitar stock negativo antes de procesar
...
-- procedure 2: vinculaciÃ³n automÃ¡tica de gastos de compras al costo real del proyecto
-- cuando se aprueba una orden de compra de un proyecto, este sp acumula automÃ¡ticamente el costo al total del proyecto
...
begin
    ...
    -- si la orden estÃ¡ amarrada a un proyecto, actualizamos el costo real del proyecto
